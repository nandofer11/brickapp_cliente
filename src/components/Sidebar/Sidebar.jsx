...
const Sidebar = () => {
    return (
        <div className="sidebar">
            <div className="d-flex flex-column p-4 text-white bg-primary" style={{ height: '100vh', width: '280px'}}>
                ...
                <ul className="nav nav-pills flex-column mb-auto">
                    ...
                    <li>
                        <NavLink to='/admin/dashboard' className='' aria-current="page">
                    ...
                    <li>
                        <NavLink to='/admin/coccion' className="" >
                    ...
                    <li>
                        <NavLink to='/admin/trabajadores' href="#" className=""  >
                    ...
                    <li>
                        <NavLink to='/admin/inventario' href="#" className=""  >
                    ...
                    <li>
                        <NavLink to='/admin/reportes' href="#" className=""  >
